/**
 * Vercel entry point for /api/transition.
 *
 * The handler itself lives in src/routes and is bundled into
 * generated/transition.js by this package's build. Only that bundle is
 * imported here, and deliberately: Vercel's zero-config builder transpiles
 ...
 */
export { POST } from '../generated/transition.js';
